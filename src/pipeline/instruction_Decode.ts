...
import { DecodedValues } from "./execute";
...
export class Decode extends PipelineStage{
    ...
    compute() {
        if(!this.shouldStall()){
            ...
            this.opcodeNext=this.instructionNext& 0x7f;// last 7 bits
            ...
            this.imm11_0Next=(this.instructionNext>>>20)&0xfff;//next 12 logical rShift for negative numbers
            this.funct7Next=(this.instructionNext>>>25)&0x7f;//next 7
